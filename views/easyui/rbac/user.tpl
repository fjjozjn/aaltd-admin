...
$(function(){
    ...
    $("#datagrid").datagrid({
        ...
        columns:[[
            ...
            {field:'Nickname',title:'暱稱',width:100,align:'center',editor:'text'},
            {field:'Email',title:'Email',width:100,align:'center',editor:'text'},
            {field:'Remark',title:'備註',width:150,align:'center',editor:'text'},
            {field:'Lastlogintime',title:'上次登入時間',width:100,align:'center',
                formatter:function(value,row,index){
                    if(value) return phpjs.date("Y-m-d H:i:s",phpjs.strtotime(value));
                    return value;
                }
            },
            {field:'Createtime',title:'添加時間',width:100,align:'center',
                formatter:function(value,row,index){
                    if(value) return phpjs.date("Y-m-d H:i:s",phpjs.strtotime(value));
                    return value;
                }
...
<div id="tb" style="padding:5px;height:auto">
    ...
    <a href="#" icon='icon-edit' plain="true" onclick="updateuserpassword()" class="easyui-linkbutton" >修改用戶密碼</a>
</div>
<!--表格内的右键菜单-->
<div id="mm" class="easyui-menu" style="width:120px;display: none" >
    ...
    <div iconCls='icon-edit' onclick="updateuserpassword()">修改密碼</div>
...
<div id="dialog" title="添加用戶" style="width:400px;height:400px;">
...
<div id="dialog2" title="修改用戶密碼" style="width:400px;height:200px;">
    <div style="padding:20px 20px 40px 80px;" >
        <table>
            <tr>
                <td>密碼：</td>
