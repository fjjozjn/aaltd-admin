...
<script type="text/javascript">
    function add(){
        window.open('{{.invoice_system_host}}sys/?act=com-addpurchase','my_iframe');
    }

    function find(){
        window.open('{{.invoice_system_host}}sys/?act=com-searchpurchase&page=1','my_iframe');
    }
...
<iframe id="my_iframe" name="my_iframe" frameborder="no" src="{{.invoice_system_host}}sys/?act=com-searchpurchase&page=1" width="100%" height="960px" scrolling="auto"></iframe>
</body>
</html>