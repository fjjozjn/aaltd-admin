...
<iframe id="my_iframe" name="my_iframe" frameborder="no" src="{{.invoice_system_host}}sys/?act=com-searchproforma&page=1" width="100%" height="960px" scrolling="auto"></iframe>
</body>
</html>